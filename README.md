<html><head><title>VISTAS - Exam Results</title>
        <link type="text/css" href="../../resources/css/CustomizeStyle2.css" rel="Stylesheet">
        <style>
            .blink {
        ...
        <form id="frmOnlineResult" name="frmOnlineResult" action="" method="post" autocomplete="off">
            <table name="Title table" width="80%" align="center" border="0" cellpadding="3" cellspacing="3">
                <tbody><tr>
                    <td align="center">
                        <div>
                            <img width="80px" align="left" height="80px" src="content://com.coloros.filemanager/root/storage/emulated/0/HTML/result/alam.jpeg"><font color="#0059b3" size="5"><b><u>VELS INSTITUTE OF SCIENCE, TECHNOLOGY AND ADVANCED STUDIES (VISTAS)</u></b> </font>
